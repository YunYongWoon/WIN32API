...
protected:
	...
	bool CollisionRectToPixel(const RECTANGLE& src, const vector<PIXEL> vecPixel, 
		int iWidth, int iHeight);
	bool CollisionSphereToPixel(const SPHERE& src, const vector<PIXEL> vecPixel,
		int iWidth, int iHeight);
	...
	bool CollisionPixelToPoint(const vector<PIXEL> vecPixel, int iWidth, int iHeight,
		const POSITION& dest);
};
